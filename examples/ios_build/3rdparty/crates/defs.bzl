...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "zstd": Label("@ios_build__zstd-0.13.2//:zstd"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//3rdparty/crates:BUILD.cc-1.0.73.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//3rdparty/crates:BUILD.jobserver-0.1.25.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//3rdparty/crates:BUILD.libc-0.2.134.bazel"),
    )

    maybe(
        http_archive,
        name = "ios_build__pkg-config-0.3.31",
    ...
    maybe(
        ...
        build_file = Label("//3rdparty/crates:BUILD.zstd-0.13.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ios_build__zstd-safe-7.2.1",
        ...
        build_file = Label("//3rdparty/crates:BUILD.zstd-safe-7.2.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ios_build__zstd-sys-2.0.13-zstd.1.5.6",
        ...
        build_file = Label("//3rdparty/crates:BUILD.zstd-sys-2.0.13+zstd.1.5.6.bazel"),
    )

    return [
        struct(repo = "ios_build__zstd-0.13.2", is_dev_dep = False),
    ]
