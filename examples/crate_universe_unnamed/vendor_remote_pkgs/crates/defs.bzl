...
def crate_repositories():
    ...
    return [struct(
        direct_deps = [
            ...
            "crates_vendor_pkgs__hyper-0.14.27",
            "crates_vendor_pkgs__mime-0.3.17",
            "crates_vendor_pkgs__serde_json-1.0.108",
            "crates_vendor_pkgs__socket2-0.4.10",
            "crates_vendor_pkgs__tokio-1.33.0",
            "crates_vendor_pkgs__tower-0.4.13",
            "crates_vendor_pkgs__tower-http-0.2.5",
            "crates_vendor_pkgs__tracing-0.1.40",
            "crates_vendor_pkgs__tracing-subscriber-0.3.17",
        ],
