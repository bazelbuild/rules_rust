...
_NORMAL_DEPENDENCIES = {
    "vendor_remote_manifests": {
        _COMMON_CONDITION: {
            "tokio": Label("@crates_vendor_manifests__tokio-1.38.0//:tokio"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__addr2line-0.22.0",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.addr2line-0.22.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__backtrace-0.3.73",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.backtrace-0.3.73.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_manifests__bitflags-2.6.0",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.bitflags-2.6.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__cc-1.0.104",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.cc-1.0.104.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__errno-0.3.9",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.errno-0.3.9.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__gimli-0.29.0",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.gimli-0.29.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__libc-0.2.155",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.libc-0.2.155.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_manifests__linux-raw-sys-0.4.14",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.linux-raw-sys-0.4.14.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__memchr-2.7.4",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__miniz_oxide-0.7.4",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.miniz_oxide-0.7.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__object-0.36.1",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.object-0.36.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_manifests__parking_lot-0.12.3",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__proc-macro2-1.0.86",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.proc-macro2-1.0.86.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__redox_syscall-0.5.2",
        sha256 = "c82cf8cff14456045f55ec4241383baeff27af886adb72ffb2162f99911de0fd",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/redox_syscall/0.5.2/download"],
        strip_prefix = "redox_syscall-0.5.2",
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.redox_syscall-0.5.2.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__syn-2.0.68",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.syn-2.0.68.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__tokio-1.38.0",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.tokio-1.38.0.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_manifests__tokio-macros-2.3.0",
        ...
        build_file = Label("@//vendor_remote_manifests/crates:BUILD.tokio-macros-2.3.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows-targets-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_aarch64_gnullvm-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_aarch64_msvc-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_i686_gnu-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_i686_gnullvm-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_i686_msvc-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_x86_64_gnu-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_x86_64_gnullvm-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates_vendor_manifests__windows_x86_64_msvc-0.52.6",
    ...
    return [
        struct(repo = "crates_vendor_manifests__tokio-1.38.0", is_dev_dep = False),
