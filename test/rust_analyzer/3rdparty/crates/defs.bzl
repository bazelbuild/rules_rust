...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.syn-2.0.115.bazel"),
    )

    maybe(
        http_archive,
        name = "rtra__unicode-ident-1.0.23",
        ...
        build_file = Label("//test/rust_analyzer/3rdparty/crates:BUILD.unicode-ident-1.0.23.bazel"),
    )
