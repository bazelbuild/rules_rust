...
def _construct_known_triples_test_impl(ctx):
    ...
    _assert_parts(env, triple("aarch64-unknown-fuchsia"), "aarch64", "unknown", "fuchsia", None)
    ...
    _assert_parts(env, triple("x86_64-unknown-fuchsia"), "x86_64", "unknown", "fuchsia", None)
