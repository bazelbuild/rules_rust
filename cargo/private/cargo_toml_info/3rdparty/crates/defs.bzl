...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "cargo_toml": Label("@rules_rust_cargo_toml_info__cargo_toml-0.20.5//:cargo_toml"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__cargo_toml-0.20.5",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.cargo_toml-0.20.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__equivalent-1.0.1",
        sha256 = "5443807d6dff69373d433ab9ef5378ad8df50ca6298caf15de6e52e24aaf54d5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/equivalent/1.0.1/download"],
        strip_prefix = "equivalent-1.0.1",
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.equivalent-1.0.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__hashbrown-0.15.1",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.hashbrown-0.15.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__indexmap-2.6.0",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.indexmap-2.6.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__memchr-2.7.4",
        sha256 = "78ca9ab1a0babb1e7d5695e3530886289c18cf2f87ec19a575a0abdce112e3a3",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/memchr/2.7.4/download"],
        strip_prefix = "memchr-2.7.4",
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.memchr-2.7.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__proc-macro2-1.0.89",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.proc-macro2-1.0.89.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__quote-1.0.37",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.quote-1.0.37.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__serde-1.0.214",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.serde-1.0.214.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__serde_derive-1.0.214",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.serde_derive-1.0.214.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__serde_spanned-0.6.8",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.serde_spanned-0.6.8.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__syn-2.0.87",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.syn-2.0.87.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__toml-0.8.19",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.toml-0.8.19.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__toml_datetime-0.6.8",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.toml_datetime-0.6.8.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__toml_edit-0.22.22",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.toml_edit-0.22.22.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__unicode-ident-1.0.13",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.unicode-ident-1.0.13.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_cargo_toml_info__winnow-0.6.20",
        ...
        build_file = Label("@rules_rust//cargo/private/cargo_toml_info/3rdparty/crates:BUILD.winnow-0.6.20.bazel"),
    )

    return [
        struct(repo = "rules_rust_cargo_toml_info__cargo_toml-0.20.5", is_dev_dep = False),
    ]
