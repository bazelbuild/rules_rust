...
def _build_script_impl(ctx):
    ...
    pkg_name = _name_to_pkg_name(ctx.attr.name)
...
def cargo_build_script(
    ...
    Args:
        name (str): The target name for the underlying rule. This should be the name of the crate being compiled, optionally with a suffix of _build_script.
