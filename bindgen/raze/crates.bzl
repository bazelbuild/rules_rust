...
def rules_rust_bindgen_fetch_remote_crates():
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:aho-corasick-0.7.13.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:ansi_term-0.11.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:atty-0.2.14.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:bindgen-0.54.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:bitflags-1.2.1.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:cc-1.0.60.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:cexpr-0.4.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:cfg-if-0.1.10.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:clang-sys-0.29.3.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:clap-2.33.3.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:env_logger-0.7.1.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:glob-0.3.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:hermit-abi-0.1.15.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:humantime-1.3.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:lazy_static-1.4.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:lazycell-1.3.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:libc-0.2.77.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:libloading-0.5.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:log-0.4.11.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:memchr-2.3.3.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:nom-5.1.2.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:peeking_take_while-0.1.2.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:proc-macro2-1.0.21.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:quick-error-1.2.3.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:quote-1.0.7.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:regex-1.3.9.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:regex-syntax-0.6.18.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:rustc-hash-1.1.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:shlex-0.1.1.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:strsim-0.8.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:termcolor-1.1.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:textwrap-0.11.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:thread_local-1.0.1.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:unicode-width-0.1.8.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:unicode-xid-0.2.1.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:vec_map-0.8.2.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:version_check-0.9.2.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:which-3.1.1.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:winapi-0.3.9.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:winapi-i686-pc-windows-gnu-0.4.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:winapi-util-0.1.5.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bindgen/raze/remote:winapi-x86_64-pc-windows-gnu-0.4.0.BUILD.bazel"),
    )
