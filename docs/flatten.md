...
cargo_bootstrap_repository(<a href="#cargo_bootstrap_repository-name">name</a>, <a href="#cargo_bootstrap_repository-binary">binary</a>, <a href="#cargo_bootstrap_repository-build_mode">build_mode</a>, <a href="#cargo_bootstrap_repository-cargo_lockfile">cargo_lockfile</a>, <a href="#cargo_bootstrap_repository-cargo_toml">cargo_toml</a>, <a href="#cargo_bootstrap_repository-env">env</a>, <a href="#cargo_bootstrap_repository-env_label">env_label</a>,
                           ...
                           <a href="#cargo_bootstrap_repository-rust_toolchain_repository_template">rust_toolchain_repository_template</a>, <a href="#cargo_bootstrap_repository-rust_toolchain_rustc_template">rust_toolchain_rustc_template</a>,
                           <a href="#cargo_bootstrap_repository-rust_toolchain_sysroot_anchor_template">rust_toolchain_sysroot_anchor_template</a>, <a href="#cargo_bootstrap_repository-rust_toolchain_sysroot_path">rust_toolchain_sysroot_path</a>, <a href="#cargo_bootstrap_repository-srcs">srcs</a>,
...
| <a id="cargo_bootstrap_repository-rust_toolchain_cargo_template"></a>rust_toolchain_cargo_template |  The template to use for finding the host <code>cargo</code> binary. <code>{version}</code> (eg. '1.53.0'), <code>{triple}</code> (eg. 'x86_64-unknown-linux-gnu'), <code>{arch}</code> (eg. 'aarch64'), <code>{vendor}</code> (eg. 'unknown'), <code>{system}</code> (eg. 'darwin'), <code>{tool}</code> (eg. 'cargo'), and <code>{ext}</code> (eg. '.exe') will be replaced in the string if present.   | String | optional | "@rust__{triple}__{tool}//:bin/{tool}{ext}" |
...
| <a id="cargo_bootstrap_repository-rust_toolchain_rustc_template"></a>rust_toolchain_rustc_template |  The template to use for finding the host <code>rustc</code> binary. <code>{version}</code> (eg. '1.53.0'), <code>{triple}</code> (eg. 'x86_64-unknown-linux-gnu'), <code>{arch}</code> (eg. 'aarch64'), <code>{vendor}</code> (eg. 'unknown'), <code>{system}</code> (eg. 'darwin'), <code>{tool}</code> (eg. 'rustc'), and <code>{ext}</code> (eg. '.exe') will be replaced in the string if present.   | String | optional | "@rust__{triple}__{tool}//:bin/{tool}{ext}" |
| <a id="cargo_bootstrap_repository-rust_toolchain_sysroot_anchor_template"></a>rust_toolchain_sysroot_anchor_template |  The template to use for finding the host <code>rustc</code> binary. <code>{version}</code> (eg. '1.53.0'), <code>{triple}</code> (eg. 'x86_64-unknown-linux-gnu'), <code>{arch}</code> (eg. 'aarch64'), <code>{vendor}</code> (eg. 'unknown'), and <code>{system}</code> (eg. 'darwin') will be replaced in the string if present.   | String | optional | "@rust__{triple}__stdlib//:BUILD.bazel" |
| <a id="cargo_bootstrap_repository-rust_toolchain_sysroot_path"></a>rust_toolchain_sysroot_path |  The path to the Rust sysroot relative to the directory of the file represented by <code>rust_toolchain_sysroot_anchor_template</code>   | String | optional | "" |
