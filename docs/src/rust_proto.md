...
load("@rules_rust_ext//prost:transitive_repositories.bzl", "rust_prost_transitive_repositories")
    ...
    annotations = {
        "protoc-gen-prost": [crate.annotation(
            ...
            patches = [
                ...
                "@rules_rust_ext//prost/private/3rdparty/patches:protoc-gen-prost.patch",
            ],
        )],
...
load("@rules_rust_ext//protobuf:transitive_repositories.bzl", "rust_proto_protobuf_transitive_repositories")
...
[@rules_rust_ext//protobuf/3rdparty/BUILD.bazel](https://github.com/bazelbuild/rules_rust/blob/main/proto/protobuf/3rdparty/BUILD.bazel)
...
toolchain(
    ...
    toolchain_type = "@rules_rust_ext//protobuf:toolchain_type",
)
```
...
Load transitive dependencies of the `@rules_rust_ext//protobuf` rules.
