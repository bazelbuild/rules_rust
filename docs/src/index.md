...
The oldest version of Bazel the `main` branch is tested against is `8.7.0`. Previous versions may still be functional in certain environments, but this is the minimum version we strive to fully support.
