...
crate.annotation(<a href="#crate.annotation-version">version</a>, <a href="#crate.annotation-additive_build_file">additive_build_file</a>, <a href="#crate.annotation-additive_build_file_content">additive_build_file_content</a>, <a href="#crate.annotation-alias_rule">alias_rule</a>,
                 ...
                 <a href="#crate.annotation-build_script_env_for_target_cfg">build_script_env_for_target_cfg</a>, <a href="#crate.annotation-build_script_proc_macro_deps">build_script_proc_macro_deps</a>, <a href="#crate.annotation-build_script_rundir">build_script_rundir</a>,
...
| <a id="crate.annotation-build_script_env_for_target_cfg"></a>build_script_env_for_target_cfg |  Additional environment variables to set on a crate's `cargo_build_script::env_for_target_cfg` attribute.   |  `None` |
...
| Name  | Description | Default Value |
| :------------- | :------------- | :------------- |
| <a id="crate_universe_dependencies-rust_version"></a>rust_version |  The version of rust to use when generating dependencies.   |  `"1.82.0"` |
