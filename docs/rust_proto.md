...
| <a id="rust_proto_toolchain-grpc_compile_deps"></a>grpc_compile_deps |  The crates the generated grpc libraries depends on.   | <a href="https://bazel.build/docs/build-ref.html#labels">List of labels</a> | optional | [Label("@io_bazel_rules_rust//proto/raze:protobuf"), Label("@io_bazel_rules_rust//proto/raze:grpc"), Label("@io_bazel_rules_rust//proto/raze:tls_api"), Label("@io_bazel_rules_rust//proto/raze:tls_api_stub")] |
...
| <a id="rust_proto_toolchain-proto_compile_deps"></a>proto_compile_deps |  The crates the generated protobuf libraries depends on.   | <a href="https://bazel.build/docs/build-ref.html#labels">List of labels</a> | optional | [Label("@io_bazel_rules_rust//proto/raze:protobuf")] |
