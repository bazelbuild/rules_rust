...
def _rust_library_impl(ctx):
  ...
  # Hash part of filename (libsomething-{hash}.rlib)
  basename_hash_plus_extension = rust_lib.basename.partition("-")[2]
  output_hash = basename_hash_plus_extension.rpartition(".")[0]
