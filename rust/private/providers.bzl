...
CrateInfo = provider(
    ...
    fields = {
        ...
        # TODO: Remove `rustc_env_attr` after refactoring rust_test to only rely on rustc_env
        "rustc_env_attr":  "Dict[String, String]: Additional `\"key\": \"value\"` environment variables to set for rustc.",
