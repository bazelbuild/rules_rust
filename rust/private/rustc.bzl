...
def rustc_default_info(providers):
    """Return the DefaultInfo generated by `rustc_compile_action`."""
    return providers[0]

def replace_rustc_default_info(providers, default_info):
    """Replace the DefaultInfo generated by `rustc_compile_action`."""
    return [default_info] + providers[1:]
