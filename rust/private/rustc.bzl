...
def construct_arguments(
    ...
    needs_extern_proc_macro_flag = crate_info.type == "proc-macro" or crate_info.wrapped_crate_type == "proc-macro"
    if needs_extern_proc_macro_flag and crate_info.edition != "2015":
        args.add("--extern")
        args.add("proc_macro")
