...
SUPPORTED_T2_PLATFORM_TRIPLES = {
    ...
    "aarch64-unknown-none": _support(std = False, host_tools = False),
    ...
    "riscv32imac-unknown-none-elf": _support(std = False, host_tools = False),
    ...
    "thumbv8m.base-none-eabi": _support(std = True, host_tools = False),
    "thumbv8m.main-none-eabi": _support(std = True, host_tools = False),
    "thumbv8m.main-none-eabihf": _support(std = False, host_tools = False),
