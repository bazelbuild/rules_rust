...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "wasm-bindgen": Label("@rrwbd//:wasm-bindgen-0.2.99"),
            "wasm-bindgen-cli-support": Label("@rrwbd//:wasm-bindgen-cli-support-0.2.99"),
            "wasm-bindgen-shared": Label("@rrwbd//:wasm-bindgen-shared-0.2.99"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//3rdparty/crates:BUILD.js-sys-0.3.76.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__lazy_static-1.5.0",
    ...
    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-0.2.99",
        ...
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-backend-0.2.99",
        ...
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-backend-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-cli-support-0.2.99",
        sha256 = "533e5315f66ba7a1c0b9731b1f6606a6fb7fc6d800eff4d5e43d48567f137203",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/wasm-bindgen-cli-support/0.2.99/download"],
        strip_prefix = "wasm-bindgen-cli-support-0.2.99",
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-cli-support-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-externref-xform-0.2.99",
        sha256 = "e71a35edea8d70380465025fcd6fb5376c9f2b5dacb2bc515bce5575e0ff0a2c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/wasm-bindgen-externref-xform/0.2.99/download"],
        strip_prefix = "wasm-bindgen-externref-xform-0.2.99",
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-externref-xform-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-macro-0.2.99",
        ...
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-macro-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-macro-support-0.2.99",
        ...
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-macro-support-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-multi-value-xform-0.2.99",
        sha256 = "58d05670395e140f246c9fd6f59ca75da67030121e1679031089aa71309d0ee5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/wasm-bindgen-multi-value-xform/0.2.99/download"],
        strip_prefix = "wasm-bindgen-multi-value-xform-0.2.99",
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-multi-value-xform-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-shared-0.2.99",
        ...
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-shared-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-threads-xform-0.2.99",
        sha256 = "578e66a90d904cc4ff44f48e8ac3f606a42ecfda5cbe336e89b315127fe02952",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/wasm-bindgen-threads-xform/0.2.99/download"],
        strip_prefix = "wasm-bindgen-threads-xform-0.2.99",
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-threads-xform-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-wasm-conventions-0.2.99",
        sha256 = "3523d0794bca5434b5e05d8cd7498ff7c6f2c86a4e5d790e35a3bd8e29c1351b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/wasm-bindgen-wasm-conventions/0.2.99/download"],
        strip_prefix = "wasm-bindgen-wasm-conventions-0.2.99",
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-wasm-conventions-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "rrwbd__wasm-bindgen-wasm-interpreter-0.2.99",
        sha256 = "0d94f86fcc9c75aac4823f9cbf156ff37e3e8f4ebc1ccff2785e045efd9aeee1",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/wasm-bindgen-wasm-interpreter/0.2.99/download"],
        strip_prefix = "wasm-bindgen-wasm-interpreter-0.2.99",
        build_file = Label("//3rdparty/crates:BUILD.wasm-bindgen-wasm-interpreter-0.2.99.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "rrwbd__wasmparser-0.212.0",
        ...
        build_file = Label("//3rdparty/crates:BUILD.wasmparser-0.212.0.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "rrwbd__wasm-bindgen-0.2.99", is_dev_dep = False),
        struct(repo = "rrwbd__wasm-bindgen-cli-support-0.2.99", is_dev_dep = False),
        struct(repo = "rrwbd__wasm-bindgen-shared-0.2.99", is_dev_dep = False),
        ...
        struct(repo = "rrwbd__tempfile-3.15.0", is_dev_dep = True),
