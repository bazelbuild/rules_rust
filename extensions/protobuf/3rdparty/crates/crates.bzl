...
# buildifier: disable=bzl-visibility
load("@rules_rust_ext//protobuf/3rdparty/crates:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("@rules_rust_ext//protobuf/3rdparty/crates:BUILD.bazel"),
        defs_module = Label("@rules_rust_ext//protobuf/3rdparty/crates:defs.bzl"),
    )
