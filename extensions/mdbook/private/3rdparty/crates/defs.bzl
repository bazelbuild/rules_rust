...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//private/3rdparty/crates:BUILD.clap-4.6.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "rmdbi__clap_complete-4.6.0",
        ...
        build_file = Label("//private/3rdparty/crates:BUILD.clap_complete-4.6.0.bazel"),
    )
