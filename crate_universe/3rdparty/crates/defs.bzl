...
def crate_repositories():
    ...
    maybe(
        ...
        aliases = {
            "anyhow": "@cui__anyhow-1.0.98//:anyhow",
            "anyhow-1.0.98": "@cui__anyhow-1.0.98//:anyhow",
            "camino": "@cui__camino-1.1.9//:camino",
            "camino-1.1.9": "@cui__camino-1.1.9//:camino",
            "cargo-lock": "@cui__cargo-lock-10.1.0//:cargo_lock",
            "cargo-lock-10.1.0": "@cui__cargo-lock-10.1.0//:cargo_lock",
            "cargo-platform": "@cui__cargo-platform-0.1.9//:cargo_platform",
            "cargo-platform-0.1.9": "@cui__cargo-platform-0.1.9//:cargo_platform",
            "cargo_metadata": "@cui__cargo_metadata-0.19.2//:cargo_metadata",
            "cargo_metadata-0.19.2": "@cui__cargo_metadata-0.19.2//:cargo_metadata",
            "cargo_toml": "@cui__cargo_toml-0.22.1//:cargo_toml",
            "cargo_toml-0.22.1": "@cui__cargo_toml-0.22.1//:cargo_toml",
            "cfg-expr": "@cui__cfg-expr-0.18.0//:cfg_expr",
            "cfg-expr-0.18.0": "@cui__cfg-expr-0.18.0//:cfg_expr",
            "clap": "@cui__clap-4.5.37//:clap",
            "clap-4.5.37": "@cui__clap-4.5.37//:clap",
            "crates-index": "@cui__crates-index-3.7.0//:crates_index",
            "crates-index-3.7.0": "@cui__crates-index-3.7.0//:crates_index",
            "glob": "@cui__glob-0.3.2//:glob",
            "glob-0.3.2": "@cui__glob-0.3.2//:glob",
            "hex": "@cui__hex-0.4.3//:hex",
            "hex-0.4.3": "@cui__hex-0.4.3//:hex",
            "indoc": "@cui__indoc-2.0.6//:indoc",
            "indoc-2.0.6": "@cui__indoc-2.0.6//:indoc",
            "itertools": "@cui__itertools-0.14.0//:itertools",
            "itertools-0.14.0": "@cui__itertools-0.14.0//:itertools",
            "maplit": "@cui__maplit-1.0.2//:maplit",
            "maplit-1.0.2": "@cui__maplit-1.0.2//:maplit",
            "normpath": "@cui__normpath-1.3.0//:normpath",
            "normpath-1.3.0": "@cui__normpath-1.3.0//:normpath",
            "once_cell": "@cui__once_cell-1.21.3//:once_cell",
            "once_cell-1.21.3": "@cui__once_cell-1.21.3//:once_cell",
            "pathdiff": "@cui__pathdiff-0.2.3//:pathdiff",
            "pathdiff-0.2.3": "@cui__pathdiff-0.2.3//:pathdiff",
            "regex": "@cui__regex-1.11.1//:regex",
            "regex-1.11.1": "@cui__regex-1.11.1//:regex",
            "semver": "@cui__semver-1.0.26//:semver",
            "semver-1.0.26": "@cui__semver-1.0.26//:semver",
            "serde": "@cui__serde-1.0.219//:serde",
            "serde-1.0.219": "@cui__serde-1.0.219//:serde",
            "serde_json": "@cui__serde_json-1.0.140//:serde_json",
            "serde_json-1.0.140": "@cui__serde_json-1.0.140//:serde_json",
            "serde_starlark": "@cui__serde_starlark-0.1.17//:serde_starlark",
            "serde_starlark-0.1.17": "@cui__serde_starlark-0.1.17//:serde_starlark",
            "sha2": "@cui__sha2-0.10.8//:sha2",
            "sha2-0.10.8": "@cui__sha2-0.10.8//:sha2",
            "spdx": "@cui__spdx-0.10.8//:spdx",
            "spdx-0.10.8": "@cui__spdx-0.10.8//:spdx",
            "tempfile": "@cui__tempfile-3.19.1//:tempfile",
            "tempfile-3.19.1": "@cui__tempfile-3.19.1//:tempfile",
            "tera": "@cui__tera-1.20.0//:tera",
            "tera-1.20.0": "@cui__tera-1.20.0//:tera",
            "textwrap": "@cui__textwrap-0.16.2//:textwrap",
            "textwrap-0.16.2": "@cui__textwrap-0.16.2//:textwrap",
            "toml": "@cui__toml-0.8.21//:toml",
            "toml-0.8.21": "@cui__toml-0.8.21//:toml",
            "tracing": "@cui__tracing-0.1.41//:tracing",
            "tracing-0.1.41": "@cui__tracing-0.1.41//:tracing",
            "tracing-subscriber": "@cui__tracing-subscriber-0.3.19//:tracing_subscriber",
            "tracing-subscriber-0.3.19": "@cui__tracing-subscriber-0.3.19//:tracing_subscriber",
            "url": "@cui__url-2.5.4//:url",
            "url-2.5.4": "@cui__url-2.5.4//:url",
            "walkdir": "@cui__walkdir-2.5.0//:walkdir",
            "walkdir-2.5.0": "@cui__walkdir-2.5.0//:walkdir",
        },
    )
