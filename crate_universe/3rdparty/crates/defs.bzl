...
_NORMAL_DEPENDENCIES = {
    "crate_universe": {
        _COMMON_CONDITION: {
            ...
            "cargo-platform": Label("@cui__cargo-platform-0.1.8//:cargo_platform"),
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "cui__cargo-platform-0.1.8",
        ...
        build_file = Label("@rules_rust//crate_universe/3rdparty/crates:BUILD.cargo-platform-0.1.8.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "cui__cargo-platform-0.1.8", is_dev_dep = False),
