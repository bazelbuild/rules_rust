...
def _annotation(
        ...
        build_script_env_for_target_cfg = None,
    ...
    Args:
        ...
        build_script_env_for_target_cfg (dict, optional): Additional environment variables to set on a crate's
            `cargo_build_script::env_for_target_cfg` attribute.
